...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HWINFO_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DRIVER_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_CDC_ACM_LOG_LEVEL, 2);
